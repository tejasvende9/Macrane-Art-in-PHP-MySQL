...
<body>
  ...
  <section class="contact_section ">
    ...
    <div class="row shadow-lg p-3">
        ...
        <div class="ps-5">
                <div>
                    <input type="submit" value="Filter Data"name="b1" class="btn btn-sm btn-primary mt-4">
                </div>
    ...
    <hr>
          ...
          <table class="table table-bordered " id="Order_Table">
            ...
            <tbody>
              ...
              $sdate=$_POST['sdate'];
              $edate=$_POST['edate'];
              $q = "SELECT DISTINCT oid,gtotal,pay_method,date FROM customer_order WHERE date between '$sdate' AND '$edate'";
